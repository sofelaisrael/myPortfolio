        ...
        <section id="contact" className="contact-me overflow-hidden flex flex-col">
            ...
            <div className="contact relative flex max-lg:item max-lg:flex-col justify-evenly pb-10">
                ...
                <div className="formdiv flex justify-center max-lg:w-full">
                    <form id="form" className="form overflow-hidden border-[#404040] w-[500px] top-0 rounded-xl gap-5 right-20  max-lg:mb-5 flex flex-col max-lg:w-[90%] max-md:mx-auto border py-10 backdrop-blur-md" ref={form} onSubmit={shoot}>
                        <div className="head text-[50px] max-md:text-[30px] text-center md:pb-5 px-10 max-md:px-5">Shoot me</div>
